                                          ...
                                          std::unique_ptr<WopiStorage::WOPIFileInfo> wopiFileInfo)
{
    ...
    disablePresentation = disablePresentation || (ConfigUtil::getBool("legacy_presentation", false) ? false :
                                                  (!ConfigUtil::getBool("experimental_features", false) && !watermarkText.empty()));
